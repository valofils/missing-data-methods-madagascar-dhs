...
> Outstanding author checks marked in the text: 0. All references still require verification before submission.
...
Development Goals [5]. In Madagascar, 40% of children under 5 are stunted [6], nearly twice the
global prevalence of 22.3% [3], and regional prevalence ranges from about 22% to 52% [6].
...
143 days [6]. All 650 clusters in the released dataset were interviewed between March and July 2021:
...
survey report [6]. Data were obtained from The DHS Program under its terms of use. The present
